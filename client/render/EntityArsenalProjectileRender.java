...
//
//        if(checkRender){TinkersArsenal.logger.info("Render Manager Loaded for EntityArsenalProjectile");}
//    }
//
//    public void renderThrownSand(EntityArsenalProjectile entityThrownSand, double x, double y, double z, float yaw, float tick) {
//        System.out.println("RENDERING PROJECTILE MODEL");
//        GlStateManager.pushMatrix();
//        GlStateManager.translate(x, y + 0.5D, z);
//        GlStateManager.scale(1.0D, 1.0D, 1.0D);
//        bindTexture(TextureMap.LOCATION_BLOCKS_TEXTURE);
...
//        GL11.glPushMatrix();
//        if(entity.motionVector!=null) {
//            GL11.glTranslated(entity.posX+entity.motionVector.getX()*partialTicks-renderManager.viewerPosX, entity.posY+entity.motionVector.getY()*partialTicks-renderManager.viewerPosY, entity.posZ+entity.motionVector.getZ()*partialTicks-renderManager.viewerPosZ);
//        }
//        else {
//            GL11.glTranslated(entity.posX+(entity.xPosQuiet-entity.xPosPrevQuiet)*partialTicks-renderManager.viewerPosX, entity.posY+(entity.yPosQuiet-entity.yPosPrevQuiet)*partialTicks-renderManager.viewerPosY, entity.posZ+(entity.zPosQuiet-entity.zPosPrevQuiet)*partialTicks-renderManager.viewerPosZ);
//        }
//
//        if(checkRender) {
