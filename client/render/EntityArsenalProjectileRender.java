...
public class EntityArsenalProjectileRender extends Render<EntityArsenalProjectile> {
    ...
    public void doRender(EntityArsenalProjectile entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        if(entity.motionVector!=null) {
            GL11.glTranslated(entity.posX+entity.motionX*partialTicks-renderManager.viewerPosX, entity.posY+entity.motionY*partialTicks-renderManager.viewerPosY, entity.posZ+entity.motionZ*partialTicks-renderManager.viewerPosZ);
        }
        else {
