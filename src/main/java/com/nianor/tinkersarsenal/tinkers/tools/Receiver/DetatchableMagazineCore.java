package com.nianor.tinkersarsenal.tinkers.tools.Receiver;
...
public class DetatchableMagazineCore extends RecieverCore {

    public DetatchableMagazineCore () {
...
*/
    ...
    public float getWeight(ItemStack detatchablemagazine)
    {
        return MechanicalNBT.from(detatchablemagazine).weight;
    }

    public float getMech(ItemStack detatchablemagazine)
    {
        return MechanicalNBT.from(detatchablemagazine).mech_effectiveness;
    }

    public int getDurability(ItemStack detatchablemagazine)
    {
        return MechanicalNBT.from(detatchablemagazine).durability;
    }

    public int getDamage(ItemStack detatchablemagazine)
    {
        return MechanicalNBT.from(detatchablemagazine).damage;
    }

    public float getHardness(ItemStack detatchablemagazine)
    {
        return MechanicalNBT.from(detatchablemagazine).hardness;
    }

    public void damageItem(ItemStack detatchablemagazine, EntityLivingBase player, int damage)
    {
        ToolHelper.damageTool(detatchablemagazine, damage, player);
    }

    @SideOnly(Side.CLIENT)
    public int getCoreColor(ItemStack detatchablemagazine)
    {
        List<Material> materials = TinkerUtil.getMaterialsFromTagList(TagUtil.getBaseMaterialsTagList(detatchablemagazine));
        return materials.get(0).materialTextColor;
    }

    @SideOnly(Side.CLIENT)
    public int getFaceColor(ItemStack detatchablemagazine)
    {
        List<Material> materials = TinkerUtil.getMaterialsFromTagList(TagUtil.getBaseMaterialsTagList(detatchablemagazine));
    ...
    @SideOnly(Side.CLIENT)
    public int getMechColor(ItemStack detatchablemagazine)
    {
        List<Material> materials = TinkerUtil.getMaterialsFromTagList(TagUtil.getBaseMaterialsTagList(detatchablemagazine));
