...
public class BeltFeedCore extends RecieverCore {
...
*/
    ...
    public float getWeight(ItemStack beltfeed)
    {
        return MechanicalNBT.from(beltfeed).weight;
    }

    public float getMech(ItemStack beltfeed)
    {
        return MechanicalNBT.from(beltfeed).mech_effectiveness;
    }

    public int getDurability(ItemStack beltfeed)
    {
        return MechanicalNBT.from(beltfeed).durability;
    }

    public int getDamage(ItemStack beltfeed)
    {
        return MechanicalNBT.from(beltfeed).damage;
    }

    public float getHardness(ItemStack beltfeed)
    {
        return MechanicalNBT.from(beltfeed).hardness;
    }

    public void damageItem(ItemStack beltfeed, EntityLivingBase player, int damage)
    {
        ToolHelper.damageTool(beltfeed, damage, player);
    }

    @SideOnly(Side.CLIENT)
    public int getCoreColor(ItemStack beltfeed)
    {
        List<Material> materials = TinkerUtil.getMaterialsFromTagList(TagUtil.getBaseMaterialsTagList(beltfeed));
        return materials.get(0).materialTextColor;
    }

    @SideOnly(Side.CLIENT)
    public int getFaceColor(ItemStack beltfeed)
    {
        List<Material> materials = TinkerUtil.getMaterialsFromTagList(TagUtil.getBaseMaterialsTagList(beltfeed));
    ...
    @SideOnly(Side.CLIENT)
    public int getMechColor(ItemStack beltfeed)
    {
        List<Material> materials = TinkerUtil.getMaterialsFromTagList(TagUtil.getBaseMaterialsTagList(beltfeed));
