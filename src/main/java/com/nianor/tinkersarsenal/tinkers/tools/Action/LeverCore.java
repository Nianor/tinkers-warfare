...
public class LeverCore extends ActionCore {
...
*/
    ...
    public float getWeight(ItemStack lever)
    {
        return MechanicalNBT.from(lever).weight;
    }

    public float getMech(ItemStack lever)
    {
        return MechanicalNBT.from(lever).mech_effectiveness;
    }

    public int getDurability(ItemStack lever)
    {
        return MechanicalNBT.from(lever).durability;
    }

    public int getDamage(ItemStack lever)
    {
        return MechanicalNBT.from(lever).damage;
    }

    public float getHardness(ItemStack lever)
    {
        return MechanicalNBT.from(lever).hardness;
    }

    public void damageItem(ItemStack lever, EntityLivingBase player, int damage)
    {
        ToolHelper.damageTool(lever, damage, player);
    }

    @SideOnly(Side.CLIENT)
    public int getCoreColor(ItemStack lever)
    {
        List<Material> materials = TinkerUtil.getMaterialsFromTagList(TagUtil.getBaseMaterialsTagList(lever));
        return materials.get(0).materialTextColor;
    }

    @SideOnly(Side.CLIENT)
    public int getFaceColor(ItemStack lever)
    {
        List<Material> materials = TinkerUtil.getMaterialsFromTagList(TagUtil.getBaseMaterialsTagList(lever));
    ...
    @SideOnly(Side.CLIENT)
    public int getMechColor(ItemStack lever)
    {
        List<Material> materials = TinkerUtil.getMaterialsFromTagList(TagUtil.getBaseMaterialsTagList(lever));
