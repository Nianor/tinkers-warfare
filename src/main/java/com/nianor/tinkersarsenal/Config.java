...
//THIS IS MOSTLY FROM DIREWOLF20
public class Config {
    ...
    public static void readConfig() {
        ...
        try {
            ...
            TinkersArsenal.logger.log(Level.ERROR, "Problem loading config file!", e1);
        } finally {
            if (cfg.hasChanged()) {
                cfg.save();
            }
    ...
    private static void initGeneralConfig(Configuration cfg) {
        ...
        //EVERYTHING AS FOLLOWS IS UNUSED, BUT LEFT IN THE CODE AS AN EXAMPLE.
