...
//NOTES FOR EVENTUAL RENDER REWRITE: "Override Item#getModel (or similar) method, create a customModelLoader, combine the models, and done." from @JTK222|Lukas#7285 on MMD Discord
    ...
    public EntityArsenalProjectile GunFire(World worldIn, EntityPlayer playerIn, double seed) {
        ...
        if(/*selector!=0&&*/getShootCooldown(playerIn.getHeldItemMainhand())==0) {
            ...
            if (inventory.fireGun(this, playerIn)/*&&!worldIn.isRemote*/) {
                ...
                projectile = new EntityArsenalProjectile(worldIn, playerIn, yaw, /*39.85F*/43.8912F, .1F, seed);
